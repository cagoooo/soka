    ...
    const handleSeed = async () => {
        ...
        try {
            ...
            const sessions = [
                ...
                // C Session
                { id: '6F_C', type: 'C', location: '六樓會三', title: '《優雅接住，情緒的浪》', description: '解析學生爆發情緒特徵，學習三階段緩降策略。透過 SEL 社會情緒學習實務，建立穩定校園支持環境。', capacity: 70, booked: 0, startTime: '40分鐘' },

                // D Session
                { id: '6F_D', type: 'D', location: '六樓會四', title: '《從餐桌到生命的美利善》', description: '探討畜牧業現況與食材選擇，破除飲食迷思。引導建立負責任的生命態度，將永續教育落實於生活。', capacity: 70, booked: 0, startTime: '40分鐘' }
            ];
